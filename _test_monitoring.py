...
fileHandler = RotatingFileHandler('/home/pi/Desktop/nagase-denki/log/_test_monitoring.log',maxBytes=1000000,backupCount=5)
...
try:
  ...
  while True:
    try:
      ...
      print("top 10differnces")
      for stat in top_stats[:10]:
        print(stat)
      
    except ConnectionError:     
      
      logger.warning('connection error! program will sleep for 5 sec before restart',sys.exc_info())
      #GPIO.cleanup()
      time.sleep(5)
    except:
